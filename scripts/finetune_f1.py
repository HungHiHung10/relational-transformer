...
if __name__ == "__main__":
    main(
        ...
        eval_pow2=False,
        max_eval_steps=40,
        load_ckpt_path="/content/drive/MyDrive/RelationalTransformer/pretrain/balmy-shadow-26/rel-f1_driver-top3_best.pt",
        # load_ckpt_path="~/scratch/rt_ckpts/pretrain_rel-amazon_user-churn.pt",
        save_ckpt_dir=None,
        compile_=True,
        seed=0,
        # data
        train_tasks=[("rel-f1", "driver-top3", "qualifying", [])],
