...
if __name__ == "__main__":
    main(
        ...
        eval_pow2=True,
        max_eval_steps=40,
        load_ckpt_path="/content/drive/MyDrive/RelationalTransformer/pretrain/scarlet-mountain-18/rel-f1_driver-top3_best.pt",
        save_ckpt_dir="ckpts/cond_pretrain/f1/",
        # compile_=True,
        compile_=False,
        seed=0,
        # data
